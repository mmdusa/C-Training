...
namespace SpaceMission
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"the second item {spaceInventory[1]} and the quantity is {itemQuantities[1]}");
            ...
            Console.WriteLine($"the first {spaceInventory[0]} and last {spaceInventory[7]}" );
